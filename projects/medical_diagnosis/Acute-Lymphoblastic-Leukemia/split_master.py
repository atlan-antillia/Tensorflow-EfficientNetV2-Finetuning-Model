...
if __name__ == "__main__":
  ...
  #       train, val, test
  ratio = (0.8,  0.0, 0.2)
  # Please rewrite the following lines depending on your environment
  # or specify input and output folders on the command line as shown below:
  # python split_master.py ./cell_images ./Malaria_Cell_Images
   
  input_folder  = "./Acute-Lymphoblastic-Leukemia-master"
  output_folder = "./Acute-Lymphoblastic-Leukemia"
