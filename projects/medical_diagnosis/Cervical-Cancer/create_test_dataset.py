...
# 2022/11/12 Copyright (C) antillia.com
...
def create_test_dataset(test_dir, target_dir, num=10):
  classes = [
    "HSIL",
    "LSIL",
    "NL",
...
if __name__ == "__main__":
  test_dir = "./Resampled-pap-smear-images/test"
  dest_dir = "./test"
  try:
    ...
    create_test_dataset(test_dir, dest_dir)
