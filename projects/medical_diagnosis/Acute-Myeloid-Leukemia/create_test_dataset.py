...
# 2023/03/30 Copyright (C) antillia.com
...
def create_test_dataset(test_dir, target_dir, num=20):
  ...
  for cls in classes:
    ...
    for i, sample in enumerate(samples):
       ...
       #target_file = target_dir + "/" + cls + "___" + nameonly + "_" + str(i+101) + ".tiff"
       # 2024/01/01 Modified to save a jpg file not a tiff file.
...
if __name__ == "__main__":
  test_dir = "./Resampled_AML_Images/test"
  dest_dir = "./test"
  try:
